...
import React from "react"; // ADDED: Import React for CSSProperties type

const BASE_URL = import.meta.env.VITE_BASE_URL;
const DEFAULT_BONUS = 1000;
const COINS_GAIN_SOUND_SRC = "/knowledge-point.mp3"; 

// FIX: Define an interface that includes your custom CSS variable
interface DailyCoinStyle extends React.CSSProperties {
  '--daily-coin-delay': string;
}
